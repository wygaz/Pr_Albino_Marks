...
def resolve_series_dir(series_name: str | None) -> tuple[Path, str]:
    scripts_dir = Path(__file__).resolve().parent
    anexos_dir = scripts_dir.parent
    series_root = anexos_dir / "SERIES"
    ...
    if not series_name:
        ...
        if last.exists():
            ...
            raise SystemExit("Informe --serie ou crie Scripts/.last_series.txt")
...
def main():
    ...
    series_dir, series_name = resolve_series_dir(args.serie)
